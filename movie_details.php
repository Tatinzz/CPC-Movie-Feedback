        ...
        <div class="card-body">
            <div class="container-fluid">
                ...
                <div class="rounded-0 mt-3">
                        <h3 class="text-muted"><b>"Would you be interested in watching this movie at Central Plaza Cinema?"</b></h3>
                        <?php 
                        ...
                        <?php if($reviews->num_rows <=0): ?>
                            <small class="tex-muted"><em></em></small>
                        <?php endif; ?>
                    <?php if($_settings->userdata('id') > 0 && $_settings->userdata('login_type') != 1): ?>
                        ...
                        <!-- End of Comment Form -->
                        <?php else: ?>
                            <center><small class="text-muted"><i>"Thank you for sharing your thoughts! Your review for this movie has been submitted."</i></small></center>
                        <?php endif; ?>
